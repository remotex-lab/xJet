...
import type { MockState } from '@global/states/mock.state';
...
// This is necessary for the interface to work with various function signatures without type constraints.

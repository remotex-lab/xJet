/**
 * Represents a collection of optional flags used for test configuration.
 *
 ...
 *
 * @remarks
 * The `TestFlags` type is commonly used to specify various states or behaviors for a test case.
 * Each property is optional, and the combination of these flags can influence how a test suite operates.
 *
 * @since 1.0.0
 */

 ...
 *
 * @remarks
 * This type is used to specify the outcome of a mock function call. It can indicate whether the function
 * successfully returned a value, threw an error, or has not yet completed execution.
 *
 * @since 1.0.0
 */

...
import type {
    ContextInterface, DescribeOptionsType, DescribeHooksInterface
...
export class DescribeModel {
    ...
    constructor(
        ...
        private readonly describeOptions: DescribeOptionsType = { skip: false, only: false }
    ) {
    }
    ...
    get options(): DescribeOptionsType {
    ...
    async run(context: ContextType<ContextInterface>): Promise<void> {
        ...
        this.notifyDescribeStatus(this.options.skip ? StatusType.SKIP : StatusType.START);
     ...
     *
     * @remarks
     * Used internally to communicate test suite lifecycle events through the emitted system

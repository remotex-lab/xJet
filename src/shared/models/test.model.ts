...
export class TestModel {
     ...
     * @param testOptions - Configuration flags that control test execution behavior
     *
     * @example
     * ```ts
     * const test = new TestModel(
    ...
    /**
     * Provides access to the test configuration flags.
     *
    ...
    /**
     * Applies execution control flags to the test, allowing it to be skipped or run exclusively.
     *
     ...
     *
     * @remarks
     * This method uses logical OR assignment (||=) to ensure flags are only set to true and

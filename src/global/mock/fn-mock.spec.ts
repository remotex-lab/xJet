...
import { fnMock, getParentObject, mock } from '@global/mock/fn.mock';
...
describe('fnMock', () => {
    ...
    test('should create a mock instance with custom implementation', () => {
        ...
        const mock = fnMock(implementation);

        const result = mock('arg1', 'arg2'); // Call the mock with arguments
    ...
    test('should create a mock instance with a custom restore function', () => {
        ...
        const mock = fnMock(implementation, restore);
    ...
    test('should create a mock instance with no initial implementation and return undefined by default', () => {
        ...
        const result = mock('arg1'); // Call the mock without an implementation
...
describe('mock', () => {
    test('should return the provided mock if the method is already mocked', () => {
        const mockFunction = fnMock();
        const result = mock(mockFunction);
    ...
    test('should throw an error if the method is not part of an object', () => {
        ...
        expect(() => mock(standaloneFunction)).toThrowError('Cannot mock function: the provided function is not provided');
    });
    ...
    test('should create a new mock for a regular function and replace the parent object\'s original method', () => {
        ...
        const mockedMethod = mock(parentObject.testMethod);
    ...
    test('should Selected part for constructor-like methods', () => {
        ...
        const mockedConstructor = mock(ParentClass.createInstance);
    ...
    test('should Selected part for constructor-like methods', () => {
        ...
        (<any> globalThis).ParentClass = ParentClass;
        const mockedConstructor = mock(ParentClass);
    ...
    test('should throw an error for invalid method types', () => {
        ...
        expect(() => mock(invalidMethod)).toThrowError('Unsupported target: method must be a valid function or constructor');
    });
});

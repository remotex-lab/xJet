...
describe('parseConfigurationFile', () => {
     ...
     *
     * The function should transpile a TypeScript file and exec it within a sandbox to extract
    ...
    test('should transpile the configuration file and return the parsed configuration object', async () => {
        (transpileFile as jest.Mock).mockResolvedValue({
            code: 'transpiledCode',
            sourceMap: '{"version":3,"names":[],"sources":[],"sourcesContent":[],"mappings":";;;AAAA,CAAC;;AACA"}'
        });

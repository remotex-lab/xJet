...
export class HookModel {
    /**
     * Represents the current location of an invocation within the application or a fallback to null.
     *
     * @remarks
     * This variable is designed
     * to hold the interface representing the invocation's location for tracking.
     * If no invocation location is available, it defaults to null.
     *
     * @since 1.0.0
     */
    ...
    constructor(
        private readonly hookFunction: CallbackHandlerType,
     ...
     *
     * @param location - An object implementing the `InvocationLocationInterface` or `null`
     *                   to reset the location.
     *
     * @remarks
     * This method assigns a new location value to the current location of the invocation.
     * Passing `null` will clear the current location.
     *
     * @since 1.0.0
     */

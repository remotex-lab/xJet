...
export class TimeoutError extends ExecutionError {
     ...
     * @param location - Optional location information with details about where the timeout occurred
     *
     * @remarks
    ...
    constructor(timeout: number, at: string, location?: InvocationLocationInterface) {
        super(`Exceeded timeout of ${ timeout } ms at ${ at }`, location);

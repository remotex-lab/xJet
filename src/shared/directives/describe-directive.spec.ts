...
describe('DescribeDirective', () => {
    ...
    describe('invoke', () => {
        ...
        test('should reset options after invoking', () => {
            const description = 'Test with options';
            const block = jest.fn();

            // eslint-disable-next-line @typescript-eslint/no-unused-expressions
            describeDirective.only;
            expect((describeDirective as any).options.only).toBe(true);
            ...
            // Verify the options were reset
            expect((describeDirective as any).options).toEqual({});
        });
    });
    ...
    describe('skip flag', () => {
        test('should set the skip flag correctly', () => {
            ...
            expect((describeDirective as any).options.skip).toBe(true);
        });

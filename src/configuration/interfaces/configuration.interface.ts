...
export interface ConfigurationInterface {
    ...
    /**
     * @property watch - Enables watch mode for rerun all tests.
     */
    ...
    /**
     * @property reporter - Specifies the time in milliseconds to wait before a dispatch operation times out.
     */
